...
import { createContact, updateContactAction, deleteContactAction } from '@/lib/actions';
                ...
                <div className="flex space-x-2">
                  <Dialog open={editingContact?.id === contact.id} onOpenChange={(open) => !open && setEditingContact(null)}>
                    ...
                    <DialogContent>
                      ...
                      <form action={(formData) => handleEditContact(contact.id, formData)} className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <Label htmlFor="name">Nome *</Label>
                          ...
                          <div>
                            <Label htmlFor="role">Cargo *</Label>
                            <Input id="role" name="role" defaultValue={contact.role} required />
                          </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      ...
                      <AlertDialogFooter>
                        ...
                        >
                          {isDeleting === contact.id ? 'Excluindo...' : 'Excluir'}
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
                  </AlertDialog>
